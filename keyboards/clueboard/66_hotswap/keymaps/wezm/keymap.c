...
[_BL] = LAYOUT(
  ...
  MO(_FL),KC_LALT,KC_LGUI,                KC_SPC, KC_SPC,                         KC_RALT,KC_RGUI,MO(_FL),KC_APP ,KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = LAYOUT(
  ...
  _______,_______,MO(_CL),_______,_______,_______,KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT,_______,_______,    _______,                             \
  _______,        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,        _______,        KC_PGUP,         \
  MO(_FL),_______,_______,                _______,_______,                        _______,_______,MO(_FL),_______,KC_HOME,KC_PGDN,KC_END),

  /* Keymap _CL: Control layer
   */
[_CL] = LAYOUT(
  BL_STEP,S_ONEUP,S_SCALE,S_BSKTC,S_ODEJY,S_RCKBY,S_DOEDR,S_COIN, S_SONIC,S_ZELDA,_______,_______,_______,     BL_TOGG,           BL_INC, \
  ...
  _______,_______,_______,                BL_BRTG,BL_BRTG,                        _______,_______,MO(_FL),_______,_______,_______,_______),
};
